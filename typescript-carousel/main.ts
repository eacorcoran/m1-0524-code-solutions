...
function rightArrowFunction(): void {
  let nextImage = 0;

  const $activeImage = document.querySelector('.image-active') as HTMLElement;
...
function leftArrowFunction(): void {
  let nextImage = 0;
...
function selectCircleFunction(event: Event): void {
